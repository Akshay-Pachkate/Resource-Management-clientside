  ...
  return (
    <>
      ...
      <div className="flex max-md:flex-col gap-4 py-4 w-full" >
        ...
        <aside className="flex flex-col max-md:gap-0 max-md:bg-gray-100 max-md:rounded-xl gap-4 w-[25%] max-md:w-full md:max-lg:w-[30%]" >
          <div className="flex gap-4 md:bg-gray-100 p-4 justify-center items-center rounded-lg " >
          ...
          <div className="sm:flex max-sm:mx-auto max-sm:grid max-sm:grid-cols-3 mx-auto md:flex-col justify-center max-sm:flex-wrap max-md:items-center sm:max-md:gap-8 max-md:gap-2 gap-[7px] w-full max-sm:mt-4  md:bg-gray-100 p-4 rounded-lg" >
        ...
        <div className="flex-1 grid grid-cols-4 max-lg:grid-cols-2  lg:max-xl:grid-cols-3 gap-4 ">
          {resources && resources.map((resource, index) =>{
            return <ResourceCard name={resource.res} location={resource.location} capacity={resource.capacity} imageUrl={resource.imgUrl} key={index} />
          })}
        </div>        
